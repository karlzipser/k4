...
from k4.utils.dict_.dict_access import *
from k4.utils.dict_.mini_menu import *
from k4.utils.misc.sys import *
from k4.utils.misc.osx import *
...
# python k4/utils/dict_/dict_nav.py --path Desktop --max_depth 5 --preview_h 800 --preview_w 800    
# python k4/utils/dict_/dict_nav.py --path iCloud_Links/jpg/2020/6 --max_depth 5 --preview_h 800 --preview_w 800
